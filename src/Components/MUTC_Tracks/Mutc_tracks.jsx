  ...
  return (
    <section className="tracks" id='tracks'>
        <div className="tracks-container">
            <div className="track">
                <img src={cyber} alt="" />
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio animi sint, illo nam porro eligendi tempore! 
                    Rem molestias quos quis cumque porro fuga eaque minus, odio dolor. Sit, deleniti mollitia.</p>
